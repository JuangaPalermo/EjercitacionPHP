    ...
    //--SQL
        ...
        public static function TraerUnUsuario($id) 
        {
                ...
                $consulta =$objetoAccesoDato->RetornarConsulta("SELECT id as id,
                                                                ...
                                                                mail as mail, 
                                                                fecha_de_registro as fechaRegistro,
        ...
        public function ModificarUsuarioParametros($claveNueva)
        {
            $objetoAccesoDato = AccesoDatos::dameUnObjetoAcceso(); 
        ...
        public static function TraerTodosLosUsuariosOrdenados($orden)
        {
            $objetoAccesoDato = AccesoDatos::dameUnObjetoAcceso();
            ...
            switch($orden)
            {
                ...
                case "descendente":
                    $consulta =$objetoAccesoDato->RetornarConsulta("SELECT id as id,nombre as nombre,
                                                                    ...
                                                                    clave as clave 
                                                                    from usuario
                                                                    ORDER BY nombre DESC, apellido DESC 
                                                                    ");
                break;
                default:
                    return NULL;
        ...
        public static function TraerTodosLosUsuariosConDeterminadaLetra($comodin)
        {
                $objetoAccesoDato = AccesoDatos::dameUnObjetoAcceso();
                $consulta =$objetoAccesoDato->RetornarConsulta("SELECT *
                                                                FROM usuario
                                                                WHERE usuario.apellido LIKE '%$comodin%' 
                                                                or usuario.nombre LIKE '%$comodin%'");
                $consulta->execute();			
                return $consulta->fetchAll(PDO::FETCH_CLASS, "usuario");		
        }
//--------------------------------//
